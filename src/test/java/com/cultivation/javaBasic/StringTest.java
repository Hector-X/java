...
class StringTest {
    ...
    void should_convert_unicode_escape() {
        ...
        // れ - U+308c
        // <--Start
        final String actual = Character.toString((char) 0x306a) + Character.toString((char) 0x306b)
                + Character.toString((char) 0x3053) + Character.toString((char) 0x308c);
        // --End-->
    ...
    void should_reverse_a_string() {
        ...
        final String reversed = stringBuffer.reverse().toString();
        // --End-->
