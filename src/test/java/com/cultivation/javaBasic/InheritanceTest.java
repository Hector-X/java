...
class InheritanceTest {
    ...
    void should_get_sorted_array() {
        ...
        PersonForEquals[] persons = new PersonForEquals[]{james1990, alice1990, james1992};
        Arrays.sort(persons);
        assertArrayEquals(new PersonForEquals[]{alice1990, james1990, james1992}, persons);
    }
}
